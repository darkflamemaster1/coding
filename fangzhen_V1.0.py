                ...
                for m in range(1,ShipNum + 1):
                        ...
                        for i in range(1,l + 1):
                                if a[row[n]][col[n] + i + ves[n].__s2__()]  == '*':
                                        if_out_of_waterway = i
                                        break
                       
                        if if_have_ship != 0:   #如果前方领域范围内有船
                                #判断是否需要追越前船
                        ...
                        elif if_have_ship == 0 and if_out_of_waterway != 0:     #如果前方领域范围内没有船但是会驶出航道
                                ...
                                if v[n] == 1 and a[row[n] + row_ + ves[n].__s1__()][col[n] + ves[n].__s2__() + col_] == 0:
                                        ...
                                        elif a[row[n]][col[n] + ves[n].__s2__() + int(v[n] * np.cos(fai))] == '*':
                                                pd = True
                                                while pd:
                                                        v[n] = v[n] - 1
                                                        row_ = int(v[n] * np.sin(fai))
                                                        col_ = int(v[n] * np.cos(fai))
                                                        if a[row[n] + ves[n].__s1__() + row_][col[n]  + col_ + ves[n].__s2__()] == 0:
                                                                a[row[n] + ves[n].__s1__() + row_][col[n]  + col_] = m
                                                                col[n] = col[n] + ves[n].__s2__() + col_
                                ...
                                while pd:
                                        if a[row[n]][col[n] + v[n] + ves[n].__s2__()] == 0:
                                                ...
                                                while pd:
                                                        v[n] = v[n] - 1
                                                        if a[row[n] + 1][col[n] + v[n] + ves[n].__s2__()] == 0:
                                                                a[row[n] + 1][col[n] + v[n] + ves[n].__s2__()] = m
                                                                pd = False
                                                        elif v[n] == 1 and a[row[n]][col[n] + 1] == '*':
                                                                pd = True
                                                                while pd:
                                                                        if a[row[n] + 1][col[n] + 1] == 0:
                                                                                a[row[n] + 1][col[n] + 1] = m
                                                                                row[n] = row[n] + 1
                                                                                col[n] = col[n] + 1
                                                                                pd = False
